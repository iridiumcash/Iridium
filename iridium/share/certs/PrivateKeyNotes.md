...
unlocked to sign the Iridium-Qt.app bundle.
...
allowing somebody to distribute a Iridium-Qt.app or Iridium-qt-setup.exe with a valid
...
that the Iridium-qt.exe file inside the installer had not been tampered with.
